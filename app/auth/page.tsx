...
export const metadata: Metadata = {
  title: 'Login / Signup',
  description: 'Login or create a parent account to track classes, progress, worksheets, and recordings.'
};
      ...
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <p className="text-sm leading-7 text-slate-600">
            Demo emails after seeding: `parent@example.com` and `admin@nurtureminds.com` (use any password in local demo mode).
          </p>
        </div>
